...
describe('CreatePaymentUseCase', () => {
  ...
  it('should create a payment successfully', async () => {
    const input = { cpf: '12345678901', amount: 100, description: 'Test', paymentMethod: 'PIX' as any };
  ...
  it('should throw an error if the repository fails to save', async () => {
    ...
    const dto = { cpf: '1', amount: 10, description: 'err', paymentMethod: PaymentMethod.PIX };
